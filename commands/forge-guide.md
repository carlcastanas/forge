---
description: Navigate FORGE's current agents, skills, commands, hooks, install profiles, and docs from the live repository surface.
---

# /forge-guide

Use this command as a conversational map of FORGE. It should help the user discover the right FORGE surface for their task without dumping the entire README or stale catalog counts.
...
/forge-guide setup
/forge-guide skills
/forge-guide commands
/forge-guide hooks
/forge-guide install
/forge-guide find: <query>
/forge-guide <feature-or-file-name>
```
...
- `scripts/ci/catalog.js --json` for live catalog counts when running inside FORGE
...
- `/project-init` for stack-aware FORGE onboarding of a target project
