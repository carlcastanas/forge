...
The script audits the current working directory by default and auto-detects whether the target is the FORGE repo itself or a consumer project using FORGE.
...
6. Suggested FORGE skills to apply next.
