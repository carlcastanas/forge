...
Use this playbook when release copy or roadmap text mentions FORGE Tools
...
2. Check the current repo and public listing surfaces:
   - `gh api repos/FORGE-Tools/FORGE-Tools`
   - ``
...
- `rg -n "billing|Billing|Marketplace|marketplace|subscription|seat|entitlement|plan" README.md docs/releases/2.0.0-rc.1 docs/FORGE-2.0-GA-ROADMAP.md`
- `gh api repos/FORGE-Tools/FORGE-Tools`
- Manual live check of ``
- `npx --yes markdownlint-cli docs/releases/2.0.0-rc.1/*.md docs/FORGE-2.0-GA-ROADMAP.md`
- `git diff --check`
