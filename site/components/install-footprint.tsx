      ...
      <div>
        ...
        <dl className="kv">
          <div className="kv__row">
            <dt className="kv__key u-mono">claude, claude-project</dt>
          ...
          <div className="kv__row">
            <dt className="kv__key u-mono">cursor</dt>
            <dd className="kv__val">
          ...
          <div className="kv__row">
            <dt className="kv__key u-mono">codex</dt>
            <dd className="kv__val">
          ...
          <div className="kv__row">
            <dt className="kv__key u-mono">opencode</dt>
            <dd className="kv__val">
