...
git clone https://github.com/yourusername/forge-kiro-public-repo.git
cd forge-kiro-public-repo
...
- **Migration Guide**: `docs/migration-from-forge.md` - For Claude Code users
