...
Bring [FORGE](https://github.com/anthropics/courses/tree/master/forge) (FORGE) workflows to [Kiro](https://kiro.dev). This repository provides custom agents, skills, hooks, steering files, and scripts that can be installed into any Kiro project with a single command.
...
├── migration-from-forge.md         # Migration guide from FORGE
└── FORGE-KIRO-INTEGRATION-PLAN.md  # Integration plan and analysis
```
