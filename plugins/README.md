...
Plugins extend Claude Code with new tools and capabilities. This guide covers installation only - see the [full article](/status/2012378465664745795) for when and why to use them.
