...
Resolve the active FORGE plugin root with the same walker `hooks/hooks.json`
...
python3 "$FORGE_ROOT/skills/continuous-learning-v2/scripts/instinct-cli.py" status
```
