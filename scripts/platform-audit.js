...
function usage() {
  console.log([
    ...
    '',
    'Operator readiness audit for FORGE queue, discussion, roadmap, release, and security evidence.',
    '',
    'Options:',
...
function buildReport(options) {
  ...
  checks.push(buildCheck(
    ...
    { fix: 'Re-run with working gh authentication or FORGE_GH_SHIM for deterministic tests.' }
  ));
...
function renderText(report) {
  const lines = [
    `FORGE Platform Audit: ${report.ready ? 'ready' : 'attention required'}`,
