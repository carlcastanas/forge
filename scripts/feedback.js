...
Usage: forge feedback [--json] [--help|-h]

Print FORGE's low-friction public feedback routes. This command never uploads
...
function printHuman() {
  process.stdout.write([
    ...
    '',
    'FORGE does not upload diagnostics or read project files. Redact sensitive information before posting publicly.',
    '',
  ].join('\n'));
}
