#!/usr/bin/env node
/**
 * Refactored FORGE installer runtime.
 *
...
Targets:
  claude       (default) - Install FORGE into ~/.claude/ with managed rules under rules/forge and flat skills under skills/
  claude-project - Install FORGE into ./.claude/ (per-project) with managed rules under rules/forge and flat skills under skills/
  ...
  kimi         - Install Kimi Code project instructions, skills, and MCP config into ./.kimi-code/ (FORGE hooks not configured)
...
Options:
  ...
  --config <path>     Load install intent from forge-install.json
