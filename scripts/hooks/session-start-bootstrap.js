 ...
 *
 * Bootstrap loader for the FORGE SessionStart hook.
 *
 ...
 *   2. Resolves the FORGE plugin root directory (via CLAUDE_PLUGIN_ROOT env var
...
process.stderr.write(
  '[SessionStart] WARNING: could not resolve FORGE plugin root; skipping session-start hook\n'
);
process.stdout.write(raw);
