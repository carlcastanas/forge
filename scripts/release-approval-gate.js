...
const REQUIRED_DECISIONS = [
  ...
  {
    id: 'forge-tools-billing-language',
    label: 'FORGE Tools billing language',
  },
  {
    id: 'video-upload',
    label: 'Video upload',
...
const REQUIRED_URL_SURFACES = [
  ...
  {
    id: 'forge-tools-billing-readiness-url',
    label: 'FORGE Tools billing/readiness URL',
    exampleUrl: 'https://github.com/FORGE-Tools',
  },
];
