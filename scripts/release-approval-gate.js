...
const SCHEMA_VERSION = 'forge.release-approval-gate.v1';
...
const REQUIRED_DECISIONS = [
  ...
  {
    id: 'outbound-growth',
    label: 'Conference, podcast, and community outreach',
  },
];
...
const REQUIRED_URL_SURFACES = [
  {
    ...
    exampleUrl: 'https://github.com/carlcastanas/forge/releases/tag/v2.0.0-rc.1',
  },
  {
    id: 'npm-rc-package-url',
    label: 'npm rc package URL',
    exampleUrl: 'https://www.npmjs.com/package/forge-universal/v/2.0.0-rc.1',
  },
  {
    id: 'claude-plugin-tag-url',
    label: 'Claude plugin tag URL',
    exampleUrl: 'https://github.com/carlcastanas/forge/releases/tag/forge--v2.0.0-rc.1',
  },
  {
    id: 'codex-repo-marketplace-evidence',
    label: 'Codex repo-marketplace evidence',
    exampleUrl: 'https://github.com/carlcastanas/forge/tree/v2.0.0-rc.1/.codex-plugin',
  },
  {
    id: 'primary-launch-video-url',
    label: 'Primary launch video URL',
    exampleUrl: '/status/0000000000000000000',
  },
  {
    id: 'short-clip-urls',
    label: 'Short clip URLs',
    exampleUrl: '/status/0000000000000000001',
  },
];
...
function topActionsForChecks(checks) {
  ...
  if (failedIds.has('release-url-ledger-finalized')) {
    actions.push('Replace approval-gated URL ledger rows with live readback URLs from the approved release, package, plugin, and video surfaces.');
  }
...
function buildReport(options = {}) {
  ...
  const checks = [
    ...
    makeCheck(
      ...
      'Restore the owner-packet sentence that blocks outbound, posts, package publish, and plugin tags.'
    ),
  ];
