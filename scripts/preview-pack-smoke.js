...
const SCHEMA_VERSION = 'forge.preview-pack-smoke.v1';
...
const REQUIRED_VERIFICATION_COMMANDS = [
  ...
  'node tests/docs/forge2-release-surface.test.js',
  'node tests/run-all.js',
  'cd forge2 && cargo test',
];
...
const HERMES_BOUNDARY_MARKERS = [
  ...
  'FORGE v2.0.0-rc.1 documents the Hermes surface',
...
function usage() {
  console.log([
    ...
    '',
    'Deterministic smoke gate for the FORGE 2.0 rc.1 preview pack.',
    '',
    'Options:',
...
function buildReport(options = {}) {
  ...
  const checks = [
    ...
    makeCheck(
      ...
      'Keep publication blockers explicit until the live release, package, and plugin surfaces exist.'
    ),
  ];
