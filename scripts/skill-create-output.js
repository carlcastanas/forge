...
class SkillCreateOutput {
  ...
  header() {
    ...
    console.log(chalk.bold(chalk.magenta('║')) + chalk.bold('  FORGE Skill Creator                                           ') + chalk.bold(chalk.magenta('║')));
...
`));
  ...
  footer() {
    ...
    console.log(chalk.dim(`  Powered by FORGE • github.com/carlcastanas/forge`));
    console.log('\n');
  }
}
