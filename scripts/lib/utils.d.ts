...
/**
 * FORGE agent data root for memory persistence and related state.
 * Defaults to ~/.claude; override with FORGE_AGENT_DATA_HOME (e.g. ~/.cursor/forge).
 */
...
/** Get the canonical FORGE sessions directory ($FORGE_AGENT_DATA_HOME/session-data) */
export function getSessionsDir(): string;

/** Get the legacy sessions directory ($FORGE_AGENT_DATA_HOME/sessions) */
...
/** Get the learned skills directory ($FORGE_AGENT_DATA_HOME/skills/learned) */
