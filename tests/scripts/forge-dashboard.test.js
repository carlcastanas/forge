/**
 * Behavioral tests for forge_dashboard.py helper functions.
 */
...
const runtimeHelpersPath = path.join(repoRoot, 'scripts', 'lib', 'forge_dashboard_runtime.py');
...
spec = importlib.util.spec_from_file_location("forge_dashboard_runtime", r"""${runtimeHelpersPath}""")
...
spec.loader.exec_module(module)
try:
    module.launch_terminal('/definitely/not/a/real/forge/path')
