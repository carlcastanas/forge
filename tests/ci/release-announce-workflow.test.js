...
assert.match(discussionWorkflow, /group:\s*forge-discord-announcement-delivery/);
...
assert.match(releaseAnnounceWorkflow, /group:\s*forge-discord-announcement-delivery/);
