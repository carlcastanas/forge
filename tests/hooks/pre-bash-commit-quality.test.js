...
function inTempRepo(fn) {
  ...
  try {
    ...
    spawnSync('git', ['config', 'user.name', 'FORGE Test'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
    spawnSync('git', ['config', 'user.email', 'forge@example.com'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
