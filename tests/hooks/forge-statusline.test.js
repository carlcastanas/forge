/**
 * Tests for scripts/hooks/forge-statusline.js
 *
 * Run with: node tests/hooks/forge-statusline.test.js
 */
...
const { formatDuration, buildContextBar, readCurrentTask } = require('../../scripts/hooks/forge-statusline');
...
function makeTempConfig() {
  return fs.mkdtempSync(path.join(os.tmpdir(), 'forge-statusline-test-'));
}

function runTests() {
  console.log('\n=== Testing forge-statusline.js ===\n');
