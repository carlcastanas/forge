...
assert.match(readme, /FORGE 2\.2 includes guided package setup/i);
assert.match(readme, /npm view forge-universal version/);
...
console.log('FORGE 2.2 release copy: ok');
