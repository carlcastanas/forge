...
>
> Use the FORGE-owned namespace below for user-level Claude installs. Flat
> package-level destinations can collide with non-FORGE rule packs and do not
> match the main README guidance.

```bash
# Create the FORGE rule namespace once.
...
cp -r rules/angular ~/.claude/rules/forge/
cp -r rules/vue ~/.claude/rules/forge/
cp -r rules/nuxt ~/.claude/rules/forge/
cp -r rules/python ~/.claude/rules/forge/
cp -r rules/golang ~/.claude/rules/forge/
cp -r rules/web ~/.claude/rules/forge/
cp -r rules/react-native ~/.claude/rules/forge/
cp -r rules/swift ~/.claude/rules/forge/
cp -r rules/php ~/.claude/rules/forge/
cp -r rules/ruby ~/.claude/rules/forge/
