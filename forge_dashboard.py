#!/usr/bin/env python3
"""
FORGE Dashboard - FORGE GUI
Cross-platform TkInter application for managing FORGE components
"""
...
try:
    ...
    sys.stderr.write(
        "FORGE Dashboard requires Tkinter, which is missing from this Python install.\n"
...
from scripts.lib.forge_dashboard_runtime import launch_terminal, maximize_window

logger = logging.getLogger(__name__)

# ============================================================================
# DATA LOADERS - Load FORGE data from the project
# ============================================================================

def get_project_path() -> str:
    """Get the FORGE project path - assumes this script is run from the project dir"""
...
class ForgeDashboard(tk.Tk):
    """Main FORGE Dashboard Application"""

    def __init__(self):
        super().__init__()

        self.project_path = get_project_path()
        self.title("FORGE Dashboard - FORGE")

        maximize_window(self)

        try:
            self.icon_image = tk.PhotoImage(file='assets/images/forge-logo.png')
    ...
    def create_widgets(self):
        ...
        try:
            self.logo_image = tk.PhotoImage(file='assets/images/forge-logo.png')
        ...
        self.title_label = ttk.Label(header_frame, text="FORGE Dashboard", font=('Open Sans', 18, 'bold'))
...
Usage: This skill is automatically activated when working with related technologies."""
    ...
    def create_settings_tab(self):
        ...
        about_text = """FORGE Dashboard v1.0.0
FORGE GUI
