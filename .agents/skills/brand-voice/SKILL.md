...
5. If site copy matters, include the current FORGE landing page and repo/plugin framing.
...
## the FORGE maintainers / FORGE Defaults

If the user wants the FORGE maintainers / FORGE voice and live sources are thin, start here unless newer source material overrides it:
