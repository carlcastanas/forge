---
name: forge
description: Development conventions and patterns for forge. JavaScript project with conventional commits.
---
...
```text
fix: auto-detect FORGE root from plugin cache when CLAUDE_PLUGIN_ROOT is unset (#547) (#691)
```
...
*This skill was generated from repository history. Review and customize as needed for your team.*
