#!/usr/bin/env node
/**
 * FORGE CodeBuddy Installer (Cross-platform Node.js version)
...
function doInstall() {
  ...
  console.log('FORGE CodeBuddy Installer');
  console.log('=======================');
  console.log('');
  ...
  // Add manifest itself
  ensureManifestEntry(manifest, '.forge-manifest');
  ...
  console.log('  3. Enjoy the FORGE workflows!');
  console.log('');
