...
> Project-specific rules for the FORGE codebase. Extends common rules.
...
- Use `run-with-flags.js` wrapper for all hooks so `FORGE_HOOK_PROFILE` and `FORGE_DISABLED_HOOKS` runtime gating works
