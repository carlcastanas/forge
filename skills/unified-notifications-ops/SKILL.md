...
description: Operate notifications as one FORGE-native workflow across GitHub, Linear, desktop alerts, hooks, and connected communication surfaces. Use when the real problem is alert routing, deduplication, escalation, or inbox collapse.
metadata:
  origin: FORGE
---
...
- the user wants to consolidate overlapping notification branches or backlog proposals into one FORGE-native lane
...
Prefer FORGE-native orchestration over telling the user to adopt a separate notification product.
...
Call out what FORGE already owns.
...
### 4. Design the FORGE-native workflow
...
If FORGE already has the primitive, prefer:
...
- "Collapse overlapping notification PR ideas into one canonical FORGE lane"
