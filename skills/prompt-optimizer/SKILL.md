...
description: >-
  Analyze raw prompts, identify intent and gaps, match FORGE components
...
Analyze a draft prompt, critique it, match it to FORGE ecosystem components,
...
- User says "how should I use FORGE for..."
...
- User is asking about FORGE configuration (use `configure-forge` instead)
...
### Phase 3: FORGE Component Matching

Map intent + scope + tech stack (from Phase 0) to specific FORGE components.
...
### Section 2: Recommended FORGE Components
...
A compact version for experienced FORGE users. Vary by intent type:
...
- "Optimize this prompt for FORGE"
- "Rewrite this prompt so Claude Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt FORGE for this task?"
...
|-----------|------------------|
| `configure-forge` | User hasn't set up FORGE yet |
