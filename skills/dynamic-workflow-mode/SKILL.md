...
If the repo has FORGE2 state enabled, prefer adding or reading checkpoints through the FORGE control pane or state-store-backed scripts instead of scattering untracked notes.
