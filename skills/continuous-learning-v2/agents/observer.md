...
- Project: `${XDG_DATA_HOME:-~/.local/share}/forge-homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `${XDG_DATA_HOME:-~/.local/share}/forge-homunculus/observations.jsonl`
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/forge-homunculus/projects/<project-hash>/instincts/personal/`
- Global: `${XDG_DATA_HOME:-~/.local/share}/forge-homunculus/instincts/personal/` (for universal patterns)
...
## Instincts imported from repository analysis

When instincts are imported from a repository analysis, they have:
