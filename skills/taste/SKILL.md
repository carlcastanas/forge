...
## The Pipeline — mixing the FORGE video skills

This skill is the conductor. Each FORGE skill is an instrument. Do not skip layers.
...
| Step | FORGE skill to load | What it does here |
|------|-------------------|-------------------|
