---
name: research-ops
description: Evidence-first current-state research workflow for FORGE. Use when the user wants fresh facts, comparisons, enrichment, or a recommendation built from current public evidence and any supplied local context.
metadata:
  origin: FORGE
---
