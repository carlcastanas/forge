...
For the FORGE repository's maintainer release path, especially `FORGE-031` and any
follow-up where tag identity, npm provenance, and announcement evidence must
all line up, read [references/forge-release-checklist.md](references/forge-release-checklist.md)
