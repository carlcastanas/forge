...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs an FORGE-native PRD-to-SRS lane instead of vague planning prose.
metadata:
  origin: FORGE
---
...
If useful, point to the next FORGE-native lane:
...
HANDOFF
- what should happen next and which FORGE lane should take it
```
...
- The resulting plan is reusable across Claude Code, Codex, Cursor, OpenCode, and FORGE 2.0 planning surfaces.
