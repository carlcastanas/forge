...
# 問題がMarketplace/アカウントアクセスの場合、FORGE Toolsのbilling/アカウントリカバリーを別途使用
...
1. **GitHub Issuesを確認**: [github.com/carlcastanas/forge/issues](https://github.com/carlcastanas/forge/issues)
2. **デバッグログを有効化**:
   ```bash
   export CLAUDE_DEBUG=1
