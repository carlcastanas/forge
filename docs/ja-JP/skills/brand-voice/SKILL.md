...
5. サイトコピーが重要な場合は、現在のFORGEランディングページとリポ/プラグインフレーミングを含めます。
...
## the FORGE maintainers / FORGE デフォルト

ユーザーがthe FORGE maintainers / FORGE音声を望み、ライブソースが薄い場合は、新しいソース素材が上書きしない限りここから開始：
