> **ترجمہ۔** یہ صفحہ انگریزی نسخے سے پیچھے ہے۔ مستند ماخذ [README.md](../../README.md) ہے۔
...
FORGE v2.0.0-rc.1 اس قابل استعمال پرت پر عوامی Hermes آپریٹر کہانی شامل کرتا ہے: [Hermes سیٹ اپ گائیڈ](../../docs/HERMES-SETUP.md) سے شروع کریں، پھر [rc.1 ریلیز نوٹس](../../docs/releases/2.0.0-rc.1/release-notes.md) اور [کراس-ہارنس آرکیٹیکچر](../../docs/architecture/cross-harness.md) دیکھیں۔
...
<sub>یہ ریپو ہمیشہ کے لیے MIT لائسنس یافتہ ہے۔</sub>
...
cp -R rules/typescript ~/.claude/rules/forge/  # اپنی زبان منتخب کریں
```
...
/forge:plan "یوزر تصدیق شامل کریں"
...
| --------------- | ------------------- | ----- |
| نئی feature منصوبہ بنانا | `/forge:plan "Auth شامل کریں"` | planner |
| سسٹم آرکیٹیکچر ڈیزائن | `/forge:plan` + architect agent | architect |
...
**کیا میں FORGE کو صرف کچھ اجزاء کے ساتھ استعمال کر سکتا ہوں؟**
...
ہاں۔ FORGE کراس-پلیٹ فارم ہے — Claude Code، Cursor، OpenCode، Codex، GitHub Copilot، Gemini، Zed، اور مزید کے ساتھ۔
