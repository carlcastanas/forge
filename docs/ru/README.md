...
> **140K+ звёзд** | **21K+ форков** | **170+ участников** | **12+ языковых экосистем**
...
**Система повышения эффективности для сред агентного ИИ.**
...
- **Руководство по безопасности:** [Security Guide](../../guides/the-security-guide.md) | [Тред](/status/2033263813387223421)
- **Подписаться:**
