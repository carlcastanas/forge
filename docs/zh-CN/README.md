...
使用 `/skill-create` 命令从您的仓库生成 Claude Code 技能，全程本地分析，无需外部服务：
...
### v1.0.0 — 首个版本（2026 年 9 月）

* 完整目录：智能体、技能、命令、规则与生命周期钩子。
* 适配 Claude Code、Codex、Cursor、OpenCode 等多种智能体框架。
* 参考文档、长篇指南，以及 Forge Shield 安全扫描器。
