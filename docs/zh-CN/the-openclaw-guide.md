...
我想先说明我的观点。我构建 AI 编码工具。我的 forge 仓库有 5 万多个星标。我创建了 Forge Shield。我大部分工作时间都在思考智能体应如何与系统交互，以及这些交互可能出错的方式。
...
我构建 Forge Shield 的部分原因，就是我在那一周使用 OpenClaw 期间的发现。如果你想扫描你自己的智能体设置，查找我在这里描述的那类漏洞——技能中的隐藏提示注入、过于宽泛的权限、未沙盒化的执行环境——Forge Shield 可以帮助进行此类评估。但更重要的不是任何特定的工具。
...
* [Forge Shield on npm](https://www.npmjs.com/package/forge-shield) — 零安装智能体安全扫描
