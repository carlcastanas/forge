# Codex FORGE Navigation Map

This guide helps Codex agents navigate FORGE without scanning every surface from
...
FORGE ships project-local Codex role layers in `.codex/agents/`:
