...
<img src="https://github.com/user-attachments/assets/1a471488-59cc-425b-8345-5245c7efbcef" alt="FORGE 簡明指南" />
</a>
</td>
<td width="50%">
<a href="/status/2014040193557471352">
<img src="https://github.com/user-attachments/assets/c9ca43bc-b149-427f-b551-af6840c368f0" alt="FORGE 完整指南" />
</a>
</td>
</tr>
<tr>
...
### forge.example.com - 技能建立器

從您的儲存庫自動生成 Claude Code 技能。

[安裝 GitHub App](https://github.com/apps/skill-creator) | forge.example.com
...
# 複製規則
cp forge/rules/*.md ~/.claude/rules/
...
如果您是透過 `/plugin install` 安裝 FORGE，請不要再把這些鉤子複製到 `settings.json`。Claude Code v2.1+ 會自動載入外掛中的 `hooks/hooks.json`，重複註冊會導致重複執行以及 `${CLAUDE_PLUGIN_ROOT}` 無法解析。
