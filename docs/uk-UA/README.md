...
<sub>Цей репозиторій ліцензований за MIT назавжди.</sub>
...
| [v1.9.0](https://github.com/carlcastanas/forge/releases/tag/v1.9.0) | Вибіркове встановлення, 12 мовних екосистем |
...
| [v1.6.0](https://github.com/carlcastanas/forge/releases/tag/v1.6.0) | Codex Edition |
...
Використовуйте команду `/skill-create` для локального аналізу репозиторію без зовнішніх сервісів:
...
Це аналізує вашу git-історію локально та створює:
...
<details>
<summary><strong>Спільнота</strong></summary>

<table>
<tr>
<td width="100%" align="center"><a href="https://github.com/carlcastanas/forge/discussions"><strong>Спільнота</strong><br /><sub>Питання, ідеї та Show and Tell</sub></a></td>
</tr>
</table>
</details>
