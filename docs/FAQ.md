...
### npm package or Claude Code plugin — which one?
...
### What happens when both install paths target the same harness?
...
### How do you preview an install before it runs?
...
### Something is broken. What runs first?
...
### How do you actually start using it after install?
...
### Do the commands have to be memorized?
...
### Why is the context window filling up so fast?
...
### Can FORGE run in two harnesses on the same machine?
...
### How do you turn off a single noisy hook?
...
### Should you install all of them?
...
### Where should personal skills live?
...
### How do you see what a session cost?
...
### Can cheap work be routed to a cheap model?
...
### How do you scan for supply-chain compromise?
...
### Should FORGE configuration be committed to the repository?
...
### `forge doctor` reports drift nobody caused.
...
### The agent keeps ignoring a rule you wrote.
