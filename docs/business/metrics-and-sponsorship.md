...
```bash
# Weekly downloads
curl -s https://api.npmjs.org/downloads/point/last-week/forge-universal
curl -s https://api.npmjs.org/downloads/point/last-week/forge-shield

# Last 30 days
curl -s https://api.npmjs.org/downloads/point/last-month/forge-universal
curl -s https://api.npmjs.org/downloads/point/last-month/forge-shield
```

### GitHub repository adoption

```bash
gh api repos/your-org/FORGE \
...
```bash
gh api repos/your-org/FORGE/traffic/views
gh api repos/your-org/FORGE/traffic/clones
```
...
> FORGE is now positioned as an agent harness performance system, not a config repo.
