...
```text
FORGE v2.0.0-rc.1 preview pack is ready for final release review.

FORGE 2.0 is the harness-native operator system for agentic work: skills, hooks,
...
- Hermes import guidance for turning local operator workflows into public FORGE skills

Start here: https://github.com/your-org/forge
Release notes: https://github.com/your-org/forge/blob/main/docs/releases/2.0.0-rc.1/release-notes.md
```

## X Post: Proof + Metrics

```text
FORGE v2.0.0-rc.1 keeps the public surface honest:
- reusable FORGE substrate in repo
...
In FORGE we turned this into production checks via:
- /harness-audit
- /quality-gate
...
FORGE v2.0.0-rc.1 pushes that further: reusable skills, thin harness adapters, and Hermes as the operator shell on top.
```
...
FORGE 2.0 is the harness-native operator system for agentic work. The same reusable layer now reaches Claude Code, Codex, OpenCode, Cursor, Gemini, Zed, GitHub Copilot workflows, and terminal-only operator lanes.

This release-candidate surface includes:
- sanitized Hermes setup documentation
- release notes and launch collateral
- cross-harness architecture notes
- Hermes import guidance for turning local operator patterns into public FORGE skills
