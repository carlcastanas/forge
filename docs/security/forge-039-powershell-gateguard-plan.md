# FORGE-039 PowerShell GateGuard and Audit Alignment Plan
...
- PR #2865 and related open work cover separate Bash and hook hardening. Those
  changes remain outside FORGE-039 and were not absorbed into this patch.
...
This is post-2.2 hardening of the FORGE 2 trustworthy substrate. It makes the
policy/evidence seam truthful at configured hook boundaries and prepares for
future evidence contracts while keeping FORGE authoritative over policy,
