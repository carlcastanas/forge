...
- renombra la skill cuando FORGE cambie o amplíe materialmente la superficie
- prefiere reglas, skills, scripts y MCPs nativos de FORGE sobre nuevas dependencias de terceros por defecto
...
FORGE incluye subconjuntos de skills para otros harnesses:
