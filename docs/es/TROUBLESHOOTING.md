...
Problemas comunes y soluciones para el plugin FORGE.
...
**Soluciones:**
```bash
# Primero inspecciona qué sabe FORGE sobre esta máquina
...
# Si el problema es el acceso al marketplace/cuenta, usa la recuperación de cuenta/facturación de FORGE Tools por separado; no uses la reinstalación como sustituto de la recuperación de cuenta
...
1. **Revisa los Issues de GitHub**: [github.com/carlcastanas/forge/issues](https://github.com/carlcastanas/forge/issues)
