...
Y si estás usando FORGE específicamente, este también es el espacio de problemas para el que construí Forge Shield: hooks sospechosos, patrones de inyección de prompt ocultos, permisos demasiado amplios, configuración MCP arriesgada, exposición de secretos, y las cosas que la gente absolutamente pasará por alto en una revisión manual.
...
> [La Guía Breve de FORGE](./the-shortform-guide.md)
>
