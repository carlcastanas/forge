...
- FORGE Tools: route evaluator findings into PR comments, check runs, and Linear
...
FORGE Tools already flags missing RAG/evaluator evidence for retrieval,
...
Future FORGE Tools work should consume these artifacts as fixture shape before it
...
work should consume these fixtures from FORGE Tools before adding hosted
