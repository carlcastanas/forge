...
<sub>Dieses Repo ist für immer MIT-lizenziert.</sub>
...
>
> Falls dein lokales Claude-Setup gelöscht oder zurückgesetzt wurde, beginne mit `node scripts/forge.js list-installed`, führe dann `node scripts/forge.js doctor` und `node scripts/forge.js repair` aus, bevor du irgendetwas neu installierst. Das stellt FORGE-verwaltete Dateien üblicherweise wieder her, ohne dein Setup neu aufzubauen.
...
Generiere Claude-Code-Skills aus deinem Repository:
...
Dies analysiert deine Git-Historie lokal und erzeugt:
