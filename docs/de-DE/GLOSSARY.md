...
Einheitliches Terminologie-Glossar für die deutsche (de-DE) Übersetzung von FORGE.

Leitlinie: Etablierte englische Fachbegriffe und FORGE-Oberflächennamen (`agents/`, `skills/`,
...
|---------|---------|-------|
| Agent | Agent | bleibt englisch — FORGE-Oberfläche (`agents/`) |
| Skill | Skill | bleibt englisch — FORGE-Oberfläche (`skills/`) |
| Hook | Hook | bleibt englisch — FORGE-Oberfläche (`hooks/`) |
| Command | Command | bleibt englisch als FORGE-Oberfläche (`commands/`); generisch sonst „Befehl“ |
| Rule | Rule | bleibt englisch als FORGE-Oberfläche (`rules/`); generisch sonst „Regel“ |
| Harness | Harness | bleibt englisch — keine etablierte deutsche Entsprechung |
| Instinct | Instinct | bleibt englisch — FORGE-Begriff aus Continuous Learning |
...
| Continuous Learning | Continuous Learning | FORGE-Feature-Name bleibt englisch; beschreibend „kontinuierliches Lernen“ |
| Memory | Memory | als FORGE-Konzept englisch; generisch „Speicher“ |
