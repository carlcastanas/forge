# FORGE — Agent Talimatları

Bu, yazılım geliştirme için 68 özel agent, 318 skill, 94 command ve otomatik hook iş akışları sağlayan **üretime hazır bir AI kodlama eklentisidir**.
...
skills/          — 318 iş akışı skillleri ve alan bilgisi
