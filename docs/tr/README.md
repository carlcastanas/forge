...
### v1.0.0 — İlk sürüm (Eylül 2026)

- Tam katalog: ajanlar, skill'ler, komutlar, kurallar ve yaşam döngüsü hook'ları.
- Claude Code, Codex, Cursor, OpenCode ve diğer harness'lar için adaptörler.
- Referans dokümantasyonu, uzun rehberler ve Forge Shield tarayıcısı.
