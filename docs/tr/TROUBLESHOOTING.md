...
FORGE eklentisi için yaygın sorunlar ve çözümler.
...
1. **GitHub Issues'ı Kontrol Edin**: [github.com/carlcastanas/forge/issues](https://github.com/carlcastanas/forge/issues)
