...
FORGE'de bir güvenlik açığı keşfederseniz, lütfen sorumlu bir şekilde bildirin.
...
- FORGE eklentisi ve bu depodaki tüm script'ler
...
- **Forge Shield**: Agent konfigürasyonunuzu güvenlik açıkları için tarayın — `npx forge-shield scan`
