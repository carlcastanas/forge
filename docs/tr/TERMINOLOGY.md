...
| Forge Shield | Forge Shield | - | Ürün adı korunur |
| NanoClaw | NanoClaw | - | Ürün adı korunur |
| FORGE Tools | FORGE Tools | - | Ürün adı korunur |

---

## Çeviri İlkeleri

1. **Ürün Adları**: İngilizce tutulur (Supabase, Redis, Playwright, Forge Shield)
...
6. **FORGE Terimleri**: İngilizce tutulur (agent, hook, skill, command, rule, harness)
